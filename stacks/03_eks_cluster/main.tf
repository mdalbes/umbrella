...
resource "aws_eks_cluster" "Umbrella-EKS-Cluster" {
  ...
  name     = "EKS-Cluster-umbrella-8294"
...
resource "aws_iam_policy" "Umbrella-eksWorkNodeEBSPolicy" {
  name = "eksWorkNodeEBSPolicy-umbrella-8294"
...
resource "aws_iam_policy" "Umbrella-MongoDBPolicy" {
  name = "MongoDBPolicy-umbrella-8294"
  path = "/"
...
POLICY
  ...
  name                 = "AmazonEKSNodeRole-umbrella-8294"
  path                 = "/"
}
...
POLICY
  ...
  max_session_duration = "3600"
  name                 = "AmazonEKSClusterRole-umbrella-8294"
  path                 = "/"
}
...
POLICY
  ...
  max_session_duration = "3600"
  name                 = "MongoDBRole-umbrella-8294"
  path                 = "/"
}
...
resource "aws_eks_node_group" "Umbrella-EKS-NodeGrp" {
  ...
  node_group_name = "EKS-NodeGrp-umbrella-8294"
