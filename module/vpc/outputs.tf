...
output "compute_arns" {
  description = "List of ARNs of compute subnets"
  value       = aws_subnet.compute.*.arn
}

output "compute_subnets_cidr_blocks" {
  description = "List of cidr_blocks of compute subnets"
  value       = aws_subnet.compute.*.cidr_block
}

output "compute_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of compute subnets in an IPv6 enabled VPC"
  value       = aws_subnet.compute.*.ipv6_cidr_block
}
